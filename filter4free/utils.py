...
def rename_image(path):
    for i in tqdm(os.listdir(path)):
        if i.endswith('jpg'):
            name = i.split('.')[0]+'_org.jpg'
            os.rename(os.path.join(path,i),
                      os.path.join('/Users/maoyufeng/slash/dataset/org_dataset/raw', name),
                      )
    # for i in tqdm(os.listdir(path)):
    #     if i.endswith('JPG'):
    #         os.rename(os.path.join(path, i),
    #                           os.path.join('/Users/maoyufeng/slash/dataset/org_dataset/rela', i.replace('JPG','jpg')),
    #                           )
...
if __name__ == '__main__':
    ...
    rename_image('/Users/maoyufeng/Downloads/111')